    ...
    useEffect(() => {
      if (route.params?.newCity) {
        ...
        if (id) {
          ...
          setCities(currentCities => [...currentCities, { id: newId, name, date, weather }]);
        }
      }
                ...
                <CityCard 
                  ...
                  onDelete={() => {
                    setCities(prevCities => {
                      const updatedCities = prevCities.filter(c => c.id !== city.id);
                      console.log('Deleting city:', city.id, 'Updated cities:', updatedCities);
